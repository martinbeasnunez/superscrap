...
export default function LandingsIndex() {
  ...
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: 'Montserrat, sans-serif' }}>
      ...
      {/* CTA Section */}
      <div className="bg-[#313131] py-12 sm:py-20">
        <div className="max-w-4xl mx-auto px-4 text-center text-white">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 sm:gap-3 bg-[#20B038] hover:bg-[#1a9c2f] text-white font-bold py-4 px-8 sm:py-5 sm:px-10 rounded-full transition-all shadow-lg text-sm sm:text-base"
          >
