            ...
            >
              ...
              <div className="h-48 relative overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 text-white">
                  <span className="text-3xl">{industryEmojis[industry.slug] || '🧺'}</span>
                </div>
              </div>
      ...
      <div className="bg-blue-900 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center text-white">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-bold py-4 px-8 rounded-lg transition-colors"
          >
