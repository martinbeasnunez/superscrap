...
export default function LandingsIndex() {
  ...
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: 'Montserrat, sans-serif' }}>
      {/* Hero */}
      <div className="bg-[#313131] text-white py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 bg-white/10 rounded-full px-5 py-2 text-sm font-medium mb-8">
      ...
      <div className="bg-[#313131] py-20">
        <div className="max-w-4xl mx-auto px-4 text-center text-white">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-[#20B038] hover:bg-[#1a9c2f] text-white font-bold py-5 px-10 rounded-full transition-all shadow-lg"
          >
