      ...
      >
        ...
        <div className="px-4 sm:px-6 py-3 sm:py-4 overflow-y-auto max-h-[calc(95vh-160px)] sm:max-h-[calc(90vh-180px)]">
          ...
          <div className="mb-4">
            ...
            {false && business.phone && ['nuevo', 'contactado', 'seguimiento_1', 'seguimiento_2', 'seguimiento_3'].includes(currentStage) && (
              <div className="mt-3">
                <button
                  onClick={handleAICall}
                  disabled={aiCallStatus === 'calling'}
                  className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg font-medium transition-all flex items-center justify-center gap-1.5 sm:gap-2 text-sm sm:text-base ${
                ...
                {aiCallResult && (
                  <div className={`mt-2 sm:mt-3 p-2 sm:p-3 rounded-lg border-2 ${
                    ...
                    {aiCallResult.summary && (
                      <p className="text-[10px] sm:text-xs text-gray-600 line-clamp-3">{aiCallResult.summary}</p>
                    )}
                  </div>
                )}
              </div>
